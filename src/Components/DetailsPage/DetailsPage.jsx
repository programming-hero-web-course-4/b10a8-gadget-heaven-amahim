...
const DetailsPage = () => {
    ...
    return (
        <div className="">
            ...
            {/* main */}
            <div className="-mt-32 bg-[#ECECEC] w-4/5 mx-auto rounded-xl flex p-8 items-center justify-evenly">
                {/* img */}
                <div className="">
                ...
                <div className="">
                    ...
                    <div className="flex gap-4 items-center mt-4">
                        <button className="btn btn-error">Add To Cart <FaOpencart className="text-xl"/></button>
